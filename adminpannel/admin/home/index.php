<?php 
    ...
    if(isset($_POST['submit']))   {
        ...
        $select_data = "SELECT * FROM contact_us WHERE Name= '".$name."' or Email= '".$email."' ";
        $db_conn = mysqli_query($conn, $select_data);

        if(mysqli_num_rows($db_conn) > 0) {
            $msg = 'Your request has already been sent to admin.';
        }else{
            $insert_form_data = "INSERT INTO contact_us (Name,Email,Comments) VALUES ('".$name."','".$email."','".$comm."')";
            $result = mysqli_query($conn,$insert_form_data);
            $msg = 'Your request is placed.';
        }
    }
?>
<!doctype html>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand scroll-top logo"><b></b></a>
                </div>
                <!--/.navbar-header-->
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav" id="mainNav">
                        
                        <li><a href="../registration/registraion.php" class="scroll-link">Sign Up</a></li>
                    </ul>
                </div>
                <!--/.navbar-collapse-->
            </nav>
            ...
            <div class="row mrgn30">
                ...
                <form method="post" action="" id="contactfrm" role="form">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="result">
                        <label id="postdetails"><?= $msg ?></label>    
                        </div>
                    </div>
                </form>
                <div class="col-sm-4">
